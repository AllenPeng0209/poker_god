...
HomeworkSource = Literal["mistake_cluster", "coach", "admin_campaign", "manual"]
HomeworkStatus = Literal["queued", "in_progress", "completed", "canceled"]
...
class CoachHomeworkResponse(BaseModel):
    requestId: str
